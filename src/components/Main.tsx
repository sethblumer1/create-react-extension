...
const ProfileCard = ({ person }: ProfileCardProps) => {
    const savePerson = () => {
        console.log('Saving', person.name);
    ...
    const messagePerson = () => {
        ...
        const messageButtonContainer = document.getElementsByClassName('msg-overlay-bubble-header__controls')[0];

        // Need to assert type because Element type does not have a click() method
        const writeMessageButton = messageButtonContainer.children[1] as HTMLButtonElement;
        writeMessageButton.click();

        // Wait for message box to appear
        setTimeout(() => {
            // Search user by name and company; need to grab input field first
            const searchContainer = document.getElementsByClassName('msg-connections-typeahead__top-fixed-section')[0];
            ...
            const userSearchInputField = subSearchContainer?.children[0] as HTMLInputElement;

            // Search for someone by name and company
            userSearchInputField.focus();

            // Simulate typing into the input field
            const nativeInputValueSetter = (Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype, "value") as PropertyDescriptor)?.set;
    ...
    return (
        <div className="profile-card">
            ...
            <div className="profile-info">
                <a href={person.linkedin_url} target="_blank" rel="noopener noreferrer" className="profile-name-link">
        ...
        <div className="wrapper">
            <div className="job-container">
                ...
                <div className="button-container">
                    ...
                    >
                        {jobSaving ? <Oval color="#fff" height={20} width={20} /> : jobSaved ? <FaCheck /> : "Save Job"}
                    </div>
            ...
            <div className="people-container">
                <div className="people-container">
                    ...
                    <div className="profile-list">
                        {peopleLoading ? <p>Loading...</p> : people.map(person => (
